...
function sendPaymentFromWallet(
		asset, wallet, to_address, amount, change_address, arrSigningDeviceAddresses, recipient_device_address, signWithLocalPrivateKey, handleResult , messages , paying_addresses)
{
	sendMultiPayment({
		asset: asset,
		wallet: wallet,
...
function sendMultiPayment(opts, handleResult)
{
	...
	readFundedAndSigningAddresses(
		asset, arrPayingAddresses || wallet, estimated_amount, opts.spend_unconfirmed || 'own', fee_paying_wallet,
