...
setInterval(lightWallet.refreshLightClientHistory , 20000)
...
function readFundedAddresses(asset, wallet, estimated_amount, spend_unconfirmed, handleFundedAddresses,change_address){
	...
	db.query(sql,
		asset ? [wallet, asset] : [wallet,change_address],
		function(rows){
...
function readFundedAndSigningAddresses(
		...
		arrSigningAddresses, arrSigningDeviceAddresses, handleFundedAndSigningAddresses,change_address)
{
...
function sendPaymentFromWallet(
		asset, wallet, to_address, amount, change_address, arrSigningDeviceAddresses, recipient_device_address, signWithLocalPrivateKey, handleResult,messages)
{
	sendMultiPayment({
		asset: asset,
		wallet: wallet,
