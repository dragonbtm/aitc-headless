...
//		throw Error("no parent props for light");
	...
	async.series([
		...
		function(cb){ // input coins
				objUnit.headers_commission = conf.free ? objectLength.getHeadersSize(objUnit) : 0;

			var naked_payload_commission = conf.free ? objectLength.getTotalPayloadSize(objUnit) : 0; // without input coins
			...
			if (params.inputs){ // input coins already selected
				...
				objUnit.payload_commission = conf.free ? objectLength.getTotalPayloadSize(objUnit) : 0;
				return cb();
			}
